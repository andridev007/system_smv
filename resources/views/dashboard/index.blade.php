...
<div class="p-4 lg:p-6 space-y-6">
    ...
    <div class="grid grid-cols-2 gap-4">
        <!-- 1. Referral Link Box with Copy Button -->
        ...
        <!-- 4. Referral Bonus -->
        <div class="bg-pink-600 rounded-xl p-4 text-white">
            <div class="flex items-center gap-2 mb-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gradient-to-r from-orange-500 to-red-500 rounded-xl p-4 text-white">
            ...
            <a href="{{ route('withdraw') }}" class="inline-block mt-2 bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg text-sm font-semibold transition">
                Withdraw Now →
            </a>
        </div>
    </div>
    ...
    <div class="bg-slate-800 rounded-xl p-4">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('transactions') }}" class="text-blue-400 text-sm hover:text-blue-300">View All</a>
        </div>
