...
<div class="bg-gray-800 shadow-md rounded-lg px-8 py-6">
    <h2 class="text-2xl font-semibold text-center text-gray-100 mb-6">Register</h2>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-4">
            <label for="nama_user" class="block text-sm font-medium text-gray-300 mb-2">Full Name</label>
            <input type="text" name="nama_user" id="nama_user" value="{{ old('nama_user') }}" required autofocus
        ...
        <div class="mb-4">
            <label for="hp" class="block text-sm font-medium text-gray-300 mb-2">Phone Number</label>
        ...
        <div class="mb-6">
            <label for="referral_code" class="block text-sm font-medium text-gray-300 mb-2">Referral Code</label>
