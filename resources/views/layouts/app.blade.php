    ...
    <body class="bg-[#0f172a] text-white antialiased min-h-screen">
        ...
        <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-slate-800 border-t border-slate-700 z-50">
            <div class="flex items-center justify-around h-16">
                ...
                <a href="{{ route('transactions') }}" class="flex flex-col items-center justify-center w-full h-full {{ request()->routeIs('transactions') ? 'text-blue-400' : 'text-slate-400 hover:text-white' }} transition">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                    </svg>
